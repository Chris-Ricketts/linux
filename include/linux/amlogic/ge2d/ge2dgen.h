...
void ge2dgen_src2(struct ge2d_context_s *wq, unsigned canvas_addr, unsigned format);
...
void ge2dgen_cb(struct ge2d_context_s *wq, int (*cmd_cb)(unsigned), unsigned param);
